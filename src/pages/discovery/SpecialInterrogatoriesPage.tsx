...
import SpecialInterrogatoriesController from "@/components/discovery/SpecialInterrogatoriesController";

// Types
import { CaseData, Document } from "@/components/discovery/types";

const SpecialInterrogatoriesPage = () => {
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6 max-w-7xl mx-auto">
        ...
        <div>
          ...
          <p className="text-sm md:text-base text-gray-600">
            Custom questions tailored specifically to{" "}
        ...
        {showDocumentSection && extractedData && (
          <div className="space-y-4">
            <SpecialInterrogatoriesController
...
export default SpecialInterrogatoriesPage;
